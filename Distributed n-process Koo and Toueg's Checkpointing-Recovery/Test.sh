...
ssh -l "$remoteuser" "$remotecomputer1" "cd $HOME/AOS/Checkpoint/src;java Main 0" &
ssh -l "$remoteuser" "$remotecomputer2" "cd $HOME/AOS/Checkpoint/src;java Main 1" &
ssh -l "$remoteuser" "$remotecomputer3" "cd $HOME/AOS/Checkpoint/src;java Main 2" &
ssh -l "$remoteuser" "$remotecomputer4" "cd $HOME/AOS/Checkpoint/src;java Main 3" &

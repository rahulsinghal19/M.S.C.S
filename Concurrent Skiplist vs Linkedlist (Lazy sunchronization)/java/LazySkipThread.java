...
public class LazySkipThread extends Thread {
	...
	public LazySkipThread(LazySkipList list, int numberOfOperations,
		...
		for (int i = 0; i < numberOfOperations; i++) {
			...
			case 1:
				...
				if (returnResultAdd) {
					...
					ListTest.addOps.getAndIncrement();
				}
				break;
			case 2:
				...
				if (returnResultRemove) {
					...
					ListTest.delOps.getAndIncrement();
				}
				break;
			default:
